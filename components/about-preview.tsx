...
export default function AboutPreview() {
  ...
  I'm a developer passionate about web applications and new technologies. Currently, I work at Africa-based Echo Solutions Ltd, building impactful projects and sharpening my skills.
</p>

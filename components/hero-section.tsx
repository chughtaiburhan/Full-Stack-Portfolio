        ...
        <div className="w-full">
          ...
          <div className="text-center mb-8 animate-fade-in-up">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-gray-900 leading-tight">
              Hi, I'm <span className="text-emerald-700 bg-gradient-to-r from-emerald-600 to-emerald-800 bg-clip-text text-transparent">Burhan</span>
            </h1>
          ...
          <div className="flex justify-center gap-4 mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <a
              href="https://www.linkedin.com/in/muhammad-burhan-chughtai-108a71332/"
              target="_blank"
            ...
            <a
              href="https://github.com/chughtaiburhan"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="chughtaiburhan3@gmail.com"
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            ...
            <Button 
              onClick={() => window.open("https://drive.google.com/file/d/1uKVgF550fnypnPAuTR1MZIGlWRHLlKHv/view?usp=sharing", "_blank")}
          ...
          <div className="mt-12 grid grid-cols-3 gap-8 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <div className="text-center group">
              <div className="text-2xl md:text-3xl font-bold text-emerald-700 group-hover:scale-110 transition-transform duration-300">5+</div>
              <div className="text-sm md:text-base text-gray-600 font-medium">Projects</div>
            </div>
            <div className="text-center group">
              <div className="text-2xl md:text-3xl font-bold text-emerald-700 group-hover:scale-110 transition-transform duration-300">2+</div>
